...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CEvrlEA5.js");
...
const manifest = {
  "fa8b018d25091808e4557cd85750b8f301c3f468d03885c39366e0201ab2cad4": {
    ...
    importer: () => import("./usuarios.functions-DELQwl3V.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C2wO3Uo9.js").then((n) => n.r),
