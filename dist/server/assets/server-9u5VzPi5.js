...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-0cF0xmse.js");
...
const manifest = {
  "fa8b018d25091808e4557cd85750b8f301c3f468d03885c39366e0201ab2cad4": {
    ...
    importer: () => import("./usuarios.functions-D8Vw_Ipz.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-OHh7bvQb.js").then((n) => n.r),
