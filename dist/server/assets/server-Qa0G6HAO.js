...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DuovtSca.js");
...
const manifest = {
  "fa8b018d25091808e4557cd85750b8f301c3f468d03885c39366e0201ab2cad4": {
    functionName: "listUsuarios_createServerFn_handler",
    importer: () => import("./usuarios.functions-C4q8fhHp.js")
  },
  "6be9b074e1dc75034aadf509e0ecb0212a4834f104076be035564e1b5fbcb29e": {
    functionName: "criarUsuario_createServerFn_handler",
    importer: () => import("./usuarios.functions-C4q8fhHp.js")
  },
  "2e7d4de4d12e3a489f09a715dae30130e6bbefb367da9168dbad787a1b99e177": {
    functionName: "editarUsuario_createServerFn_handler",
    importer: () => import("./usuarios.functions-C4q8fhHp.js")
  },
  "8de4718dddfb2e868007204d953b75e12394ef529404b76c21f4378e8276756a": {
    functionName: "toggleAtivoUsuario_createServerFn_handler",
    importer: () => import("./usuarios.functions-C4q8fhHp.js")
  },
  "e85438eaa5d5896a10b1304167a57799001a3b6acf9fa48ae7972b9d7d96210e": {
    functionName: "alterarSenhaUsuario_createServerFn_handler",
    importer: () => import("./usuarios.functions-C4q8fhHp.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CBWW-jsc.js").then((n) => n.r),
    import("./start-C4TRlFXi.js"),
