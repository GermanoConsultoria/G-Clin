...
const CATEGORIAS_FALLBACK = [{
  value: "sobrancelhas",
  label: "Sobrancelhas",
  color_class: "bg-pink-100 text-pink-700 border-pink-200"
}, {
  value: "micropigmentacao",
  label: "Micropigmentação",
  color_class: "bg-purple-100 text-purple-700 border-purple-200"
}, {
  value: "depilacao",
  label: "Depilação",
  ...
  color_class: "bg-emerald-100 text-emerald-700 border-emerald-200"
}, {
  value: "hof",
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-4 flex flex-wrap items-center gap-3", children: [
      ...
      }].map((opt) => /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setFiltroPeriodo(opt.value), className: `rounded-md px-3 py-1.5 text-sm font-medium transition-colors ${filtroPeriodo === opt.value ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`, children: opt.label }, opt.value)) }),
    ...
    loading ? /* @__PURE__ */ jsx("div", { className: "text-muted-foreground", children: "Carregando..." }) : /* @__PURE__ */ jsxs(Tabs, { defaultValue: "list", className: "w-full", children: [
      ...
      /* @__PURE__ */ jsx(TabsContent, { value: "calendar", className: "mt-4", children: /* @__PURE__ */ jsx(CalendarView, { appts: apptsFiltrados, services, onEdit: (a) => {
        setEditing(a);
        setOpen(true);
      } }) })
    ] }),
