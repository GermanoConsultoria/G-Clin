...
VALUES
  ('62ed267a-991b-4ccb-a3e1-e3a9b687e4ec', 'maquiagem', 'Maquiagem', 'bg-rose-100 text-rose-700 border-rose-200',     7),
  ('62ed267a-991b-4ccb-a3e1-e3a9b687e4ec', 'penteado',  'Penteado',  'bg-violet-100 text-violet-700 border-violet-200', 8)
...
VALUES
  (
    '62ed267a-991b-4ccb-a3e1-e3a9b687e4ec',
    'Maquiagem Infantil',
